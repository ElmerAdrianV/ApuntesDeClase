...
\begin{center}
    ...
    \end{tabular}
    \end{center}
\noindent \textbf{Definición: }  Sea $B\subseteq\mathbb{R}^n$. Decimos que $B$ es cerrado si $B^c$ es abierto.
...
\newpage
\section*{Límites}
\noindent\textbf{Definición formal de límite:} Sea $f:A\subseteq\mathbb{R}^n\rightarrow\mathbb{R}^m$ con $A$ abierto y 
sea $\vec{a}\in A$\newline
Decimos que
\begin{center}
