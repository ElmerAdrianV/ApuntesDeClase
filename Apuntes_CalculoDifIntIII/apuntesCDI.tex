...
\noindent\textbf{Teorema (semi-formal):} Si $f(\vec{x})$ es una \emph{función racional}, es decir, (con cociente de polinomios)
entonces $f$ es \emph{continua en } $\vec{a}$ si el denominador de $f(\vec{x})$ no es $0$ en $\vec{a}$.
